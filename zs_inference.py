...
class ZS_Inference:
    def __init__(self, args):
        ...
        self.shuffle = True
        #self.split = "test" if self.model_name in ["V3", "R1", "QWQ", "Q7B", "Llama", "Q8B", "Q14B", "Q32B"] else "train"
        self.split = "test"
        ...
        self.NOVITA_MODELS = ["Llama", "Q8B", "Q14B", "QWQ", "Q32B"]
        ...
        self.preds_file_path = os.path.join(self.save_path, "_".join([self.model_name, self.task, self.prompt_lang, self.prompt_type]))
        self.start = 0
    ...
    def load_data(self):
        self.dataset_helper = FT_Dataset("<｜end▁of▁sentence｜>", split=self.split, test_mode=True, shuffle=self.shuffle, shots=self.shots, prompt_type=self.prompt_type)
    ...
    def api_model_inference_deepseek(self):
        ...
        for i, text in enumerate(self.dataset["text"]):
            ...
            client = OpenAI(
                ...
                api_key="sk-f61cbe8c0d204f919000861f08c520aa",
            ) 
    ...
    def api_model_inference_novita(self):
        ...
        for i in range(len(texts) - 1, -1, -1):
            ...
            client = OpenAI(
                ...
                api_key="sk_KMU4ycRkHnOlmqDQB68ks73zeFQkziiGeAvzhqkPRQQ",
            ) 
...
if __name__ == '__main__':
    ...
    assert args.model in ["V3", "R1", "Q1.5B", "Q7B", "Llama", "Q8B", "Q14B", "QWQ", "Q32B", "Qwen"], "Invalid model!"
